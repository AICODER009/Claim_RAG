#!/usr/bin/env python3
"""Run claims 101-150 through full substantiation pipeline → MD report.

Skips the first 100 unique claims (already tested), then processes the NEXT 50.
...
SKIP = 100       # Skip first 100 (batches 1-50 and 51-100)
LIMIT = 50       # Process next 50
BATCH_LABEL = "101–150"
GLOBAL_OFFSET = 100  # Global index starts at 101

OUTPUT_MD = Path(__file__).parent.parent / "claims" / "claims_101_150_results.md"
...
def main():
    ...
    # ── Build MD Report ──
    md = []
    md.append(f"# Claims {BATCH_LABEL} — Substantiation Results\n")
